...
Aevum RRP is an early-stage protocol and implementation stack for requesting, minting, transporting, and verifying **receipts** about observed events. The goal is simple:
